//
//  CNFFactsViewController.m
//  ChuckNorrisFacts
//
//  Created by Raphael Fleischlin on 11.05.13.
...
@interface CNFFactsViewController () {

    CNFDataProvider* dataProvider;
}
@end

@implementation CNFFactsViewController
...
{
    return [[dataProvider getAllFacts] count];
}
